...
const F = {
  ...
  tradeGoods: { id: "tradeGoods", index: 3, translationKey: "sectionA.tradeGoods", tooltip: "sectionA.tradeGoodsNote", section: "A" as const },
  ...
  securityDeposits: { id: "securityDeposits", index: 11, translationKey: "sectionA.securityDeposits", section: "A" as const },
  committeeDeposits: { id: "committeeDeposits", index: 12, translationKey: "sectionA.committeeDeposits", section: "A" as const },
  ...
  businessPartnership: { id: "businessPartnership", index: 15, translationKey: "sectionA.businessPartnership", section: "A" as const },
  totalPayableDebts: { id: "totalPayableDebts", index: 1, translationKey: "sectionB.totalPayableDebts", tooltip: "sectionB.totalPayableDebtsNote", section: "B" as const },
  committeeBalance: { id: "committeeBalance", index: 2, translationKey: "sectionB.committeeBalance", section: "B" as const },
...
export const WIZARD_STEPS: StepDef[] = [
  ...
  },
  {
    ...
    icon: "minus",
    section: "B",
    fields: [F.totalPayableDebts, F.committeeBalance, F.utilityBills, F.partyPayments, F.employeeSalaries, F.previousZakat, F.installmentsDue],
  },
];

export const SECTION_A_FIELDS: ZakatFieldDef[] = WIZARD_STEPS
...
export const DEFAULT_SECTION_A: SectionAValues = {
  ...
  receivableDebts: 0, foreignCurrency: 0, sharesForSale: 0, sharesForDividends: 0,
  savingsCertificates: 0, securityDeposits: 0, committeeDeposits: 0,
  rawMaterials: 0, finishedGoods: 0, businessPartnership: 0,
};

export const DEFAULT_SECTION_B: SectionBValues = {
  totalPayableDebts: 0, committeeBalance: 0, utilityBills: 0,
  partyPayments: 0, employeeSalaries: 0, previousZakat: 0, installmentsDue: 0,
};
